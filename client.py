...
from processor import FAMILY_NAME, _hash


class clientSnort(object):
    """Client simple wallet class.
    These supports deposit, withdraw, transfer, and balance functions.
    """

    def __init__(self, baseUrl, idContainer, keyFile: object = None)
        ...
        self._signer = CryptoFactory(create_context('scp256k1')) \
